      ...
      *| DATE GENERATED: 07/05/2021 15:53                              |
      *| ID: fde5e1c6-5782-4af7-ad07-1e38b0dfb79a                      |
      *+---------------------------------------------------------------+
      *+---------------------------------------------------------------+
      *| TEST_TEST2                                                    |
      ...
      * EVALUATE OUTPUT VALUE
           ...
           END-IF
           IF (CA-RETURN-CODE OF DFHCOMMAREA IS NUMERIC)
               AND (CA-RETURN-CODE OF DFHCOMMAREA = 2) THEN
             CONTINUE
           ELSE
             MOVE CA-RETURN-CODE OF DFHCOMMAREA TO ZUT00000043(1)
             MOVE 2 TO ZUT00000043(2)
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE 'fde5e1c6-5782-4af7-ad07-1e38b0dfb79a'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
